...
const Home = () => {
    ...
    return (
        <div className="relative w-screen min-h-screen overflow-hidden bg-slate-900 flex flex-col items-center pt-28">
            {/* Boxes Background */}
                ...
                {active && typeof active === "object" ? (
                    <div className="fixed inset-0  grid place-items-center z-[100]">
                        ...
                        <motion.div
                            ...
                            ref={ref}
                            className="w-[95%] max-w-[400px] h-auto max-h-[80vh] flex flex-col bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full px-4">
                    {cards.map((card, index) => (
                        <motion.div
                            ...
                            className="flex flex-col cursor-pointer rounded-xl overflow-hidden bg-black/90 text-white shadow-lg hover:bg-gray-900/90 hover:shadow-zinc-500/30 transition"
                        >
                            ...
                            <div className="flex flex-col items-center p-4 flex-grow">
                                ...
                                <motion.p
                                    ...
                                    className="text-sm text-neutral-400 text-center mt-2"
                                >
                                    {card.description}
                                </motion.p>
